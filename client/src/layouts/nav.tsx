          ...
          <SheetContent className="w-max ">
            <div className="h-full relative">
              {[
                ...
                <div key={index} className={info.className + " text-red-600"}>
                  <SheetTrigger>
                    <button
                      className={
                        "hover-underline-animation  w-32 rounded-md bg-transparent text-sm font-normal text-secondary-foreground hover:text-line-green" +
